...
module instruction_memory(
    ...
    initial begin
        ...
        memory[23] = {4'b1011, 5'd7, 5'd15, 5'd0, 13'd0}; // SW    $r15, 0($r7)
        memory[24] = {4'b0110, 5'd5, 5'd15, 5'd16, 13'd0}; // SLT   $r16, $r5, $r15
        memory[25] = {4'b1100, 5'd16, 5'd0, 5'd0, 13'd2}; // BEQ   $r16, $zero, no_update
        memory[26] = {4'b0111, 5'd15, 5'd0, 5'd5, 13'd0}; // ADDI  $r5, $r15,0
        memory[27] = {4'b0111, 5'd7, 5'd0, 5'd6, 13'd0}; // ADDI  $r6, $r7, 0
        memory[28] = {4'b0111, 5'd7, 5'd0, 5'd7, 13'd1}; // ADDI $r7, $r7, 1
        memory[29] = {4'b0000, 5'd8, 5'd3, 5'd8, 13'd0}; // ADD  $r8, $r8, $r3
        memory[30] = {4'b0110, 5'd7, 5'd4, 5'd16, 13'd0}; // SLT  $r16, $r7, $r4
        memory[31] = {4'b1101, 5'd16, 5'd0, 5'd0, 13'd8170}; // BNE  $r16, $zero, class_loop
        memory[32] = {4'b1011, 5'd5, 5'd17, 5'd0, 13'd10}; // SW $r17, 10($r5)
    end
    always @(*) begin
        instruction = memory[address[14:2]]; // word addressing
    end
endmodule