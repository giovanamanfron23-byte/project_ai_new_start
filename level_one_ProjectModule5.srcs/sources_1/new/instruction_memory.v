...
//    output reg [31:0] instruction
//);
//    reg [31:0] memory [0:28];
//    initial begin
//        memory[0] = {4'b0111, 5'd0, 5'd0, 5'd3, 13'd784}; // ADDI $r3, $zero, 784
//        memory[1] = {4'b0111, 5'd0, 5'd0, 5'd4, 13'd10}; // ADDI $r4, $zero, 10
//        memory[2] = {4'b0111, 5'd0, 5'd0, 5'd5, 13'd0}; // ADDI $r5, $zero, 0
//        memory[3] = {4'b0111, 5'd0, 5'd0, 5'd6, 13'd8191}; // ADDI $r6, $zero, -1
//        memory[4] = {4'b0111, 5'd0, 5'd0, 5'd7, 13'd0}; // ADDI $r7, $zero, 0
//        memory[5] = {4'b0111, 5'd0, 5'd0, 5'd8, 13'd784}; // ADDI $r8, $zero, 784
//        //class_loop
//        memory[6] = {4'b0111, 5'd0, 5'd0, 5'd15, 13'd0}; // ADDI $r15, $zero, 0
//        memory[7] = {4'b0111, 5'd0, 5'd0, 5'd9, 13'd0}; // ADDI $r9, $zero, 0
//        memory[8] = {4'b0111, 5'd0, 5'd0, 5'd10, 13'd11}; // ADDI $r10, $zero, 11
//        memory[9] = {4'b0111, 5'd0, 5'd0, 5'd11, 13'd795}; // ADDI $r11, $zero, 795
//        //dot_loop
//        memory[10] = {4'b1010, 5'd10, 5'd0, 5'd12, 13'd0}; // LW  $r12, 0($r10)
//        memory[11] = {4'b1010, 5'd11, 5'd0, 5'd13, 13'd0}; // LW  $r13, 0($r11)
//        memory[12] = {4'b0010, 5'd12, 5'd13, 5'd14, 13'd0}; // MUL  $r14, $r12, $r13
//        memory[13] = {4'b0000, 5'd15, 5'd14, 5'd15, 13'd0}; // ADD  $r15, $r15, $r14
//        memory[14] = {4'b0111, 5'd10, 5'd0, 5'd10, 13'd1}; // ADDI $r10, $r10, 1
...
//        memory[21] = {4'b1100, 5'd16, 5'd0, 5'd0, 13'd2}; // BEQ   $r16, $zero, no_update
//        memory[22] = {4'b0111, 5'd15, 5'd0, 5'd5, 13'd0}; // ADDI  $r5, $r15,0
//        memory[23] = {4'b0111, 5'd7, 5'd0, 5'd6, 13'd0}; // ADDI  $r6, $r7, 0
//        //no_update
//        memory[24] = {4'b0111, 5'd7, 5'd0, 5'd7, 13'd1}; // ADDI $r7, $r7, 1
//        memory[25] = {4'b0000, 5'd8, 5'd3, 5'd8, 13'd0}; // ADD  $r8, $r8, $r3
//        memory[26] = {4'b0110, 5'd7, 5'd4, 5'd16, 13'd0}; // SLT  $r16, $r7, $r4
//        memory[27] = {4'b1101, 5'd16, 5'd0, 5'd0, 13'd8170}; // BNE  $r16, $zero, class_loop
//        memory[28] = {4'b1011, 5'd0, 5'd6, 5'd0, 13'd10}; // SW $r6, 10($zero)
...
module instruction_memory(
    ...
    initial begin
        ...
        memory[3] = {4'b0111, 5'd0, 5'd0, 5'd6, 13'd8191}; // ADDI $r6, $zero, -1
        memory[4] = {4'b0111, 5'd0, 5'd0, 5'd7, 13'd0}; // ADDI $r7, $zero, 0
        memory[5] = {4'b0111, 5'd0, 5'd0, 5'd8, 13'd0}; // ADDI $r8, $zero, 0
        memory[6] = {4'b0111, 5'd0, 5'd0, 5'd15, 13'd0}; // ADDI $r15, $zero, 0
        memory[7] = {4'b0111, 5'd0, 5'd0, 5'd9, 13'd0}; // ADDI $r9, $zero, 0
        memory[8] = {4'b0111, 5'd0, 5'd0, 5'd10, 13'd11}; // ADDI $r10, $zero, 11
        memory[9] = {4'b0111, 5'd8, 5'd0, 5'd11, 13'd795}; // ADDI $r11, $r8, 795
        memory[10] = {4'b1010, 5'd10, 5'd0, 5'd12, 13'd0}; // LW  $r12, 0($r10)
        memory[11] = {4'b1010, 5'd11, 5'd0, 5'd13, 13'd0}; // LW  $r13, 0($r11)
        memory[12] = {4'b0010, 5'd12, 5'd13, 5'd14, 13'd0}; // MUL  $r14, $r12, $r13
        memory[13] = {4'b0000, 5'd15, 5'd14, 5'd15, 13'd0}; // ADD  $r15, $r15, $r14
        ...
        memory[16] = {4'b0111, 5'd9, 5'd0, 5'd9, 13'd1}; // ADDI $r9, $r9, 1
        memory[17] = {4'b0110, 5'd9, 5'd3, 5'd16, 13'd0}; // SLT  $r16, $r9, $r3
        memory[18] = {4'b1101, 5'd16, 5'd0, 5'd0, 13'd8184}; // BNE  $r16, $zero, dot_loop
        memory[19] = {4'b1011, 5'd7, 5'd15, 5'd0, 13'd0}; // SW    $r15, 0($r7)
        memory[20] = {4'b0110, 5'd5, 5'd15, 5'd16, 13'd0}; // SLT   $r16, $r5, $r15
        memory[21] = {4'b1100, 5'd16, 5'd0, 5'd0, 13'd3}; // BEQ   $r16, $zero, no_update
        memory[22] = {4'b0111, 5'd15, 5'd0, 5'd5, 13'd0}; // ADDI  $r5, $r15,0
        memory[23] = {4'b0111, 5'd7, 5'd0, 5'd6, 13'd0}; // ADDI  $r6, $r7, 0
        memory[24] = {4'b0111, 5'd7, 5'd0, 5'd7, 13'd1}; // ADDI $r7, $r7, 1
        memory[25] = {4'b0000, 5'd8, 5'd3, 5'd8, 13'd0}; // ADD  $r8, $r8, $r3
        memory[26] = {4'b0110, 5'd7, 5'd4, 5'd16, 13'd0}; // SLT  $r16, $r7, $r4
        memory[27] = {4'b1101, 5'd16, 5'd0, 5'd0, 13'd8171}; // BNE  $r16, $zero, class_loop
        memory[28] = {4'b1011, 5'd0, 5'd6, 5'd0, 13'd10}; // SW $r6, 10($zero)
    end
    always @(*) begin
        instruction = memory[address[9:2]]; // word addressing
